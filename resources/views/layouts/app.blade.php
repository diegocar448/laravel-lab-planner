                ...
                @else
                    ...
                    @auth
                        ...
                        @if(auth()->user()->isAdmin())
                            <div class="pt-4 pb-2 px-3">
                                <span class="text-xs font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider">Administração</span>
                            </div>
                            <x-sidebar.menu-item href="{{ route('admin.users') }}">
                                <x-slot:icon>
                                    <svg fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
